...
def upgrade() -> None:
    ...
    op.add_column('garment', sa.Column('designer_tier', sa.String(32), nullable=True))  # luxury, premium, mid-range, etc.
    op.add_column('garment', sa.Column('sustainability_score', sa.Float, nullable=True))  # 0-1 score

    # Extracted confidence scores
    op.add_column('garment', sa.Column('ontology_confidence', sa.Float, nullable=True))  # Overall confidence in categorization
